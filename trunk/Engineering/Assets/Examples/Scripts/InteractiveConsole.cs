...
public sealed class InteractiveConsole : MonoBehaviour
{
    ...
    {
        UnityEngine.Debug.Log("FB.Init completed: Is user logged in? " + FB.IsLoggedIn);
        isInit = true;
    }

    private void OnHideUnity(bool isGameShown)
    {
        UnityEngine.Debug.Log("Is game showing? " + isGameShown);
    }
    ...
    {
        UnityEngine.Debug.Log("publish response: " + result.Text);
    }
